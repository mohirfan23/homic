...
Star 209
Fork 18 RubaXa/Ply
Branch: master  Ply/Ply.js
a9879a9  on 26 Jun
@RubaXa RubaXa + Ply.js
1 contributor
RawBlameHistory     2322 lines (1885 sloc)  48.5 KB
/**
...
//
                    ...
                    return _preloadImage(_this.wrapEl).then(function()  {
                        ...
                        if (state) {
                            ...
                            prevLayer.hasFlag('hideLayerInStack') && prevLayer.applyEffect('open.layer', effect).then(function()  {
                                _autoFocus(prevLayer.el); // todo: ????? ????? layer.autoFocus();
                            });
                        }
...

    {
        ...
        apply: function (el, name) {
            ...
            var effects = this[name[0]], // ??????? open/close
